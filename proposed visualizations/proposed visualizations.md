...
### 2 The bubble plot (on a map) (Pending)
...
### 5 Dot distribution map (Selected)
...
### 5 Nightingale Rose Chart (Selected)
...
### 4 Bar chart, Radial bar chart (Work Needed)
