...
# }
# r2d3(data=read.csv("src/csv/flare.csv"),css="src/css/dendogram.css", d3_version = 4, script = "src/js/dendogram.js")

r2d3(data=jsonlite::read_json("flare.json"),css="Hierarchical Bar Chart.css", d3_version = 4, script = "sunbrust.js")
